<template>
  <div>
    <!-- If there is NOT a confirmPassword, this form will show -->
    <form v-if="!confirmPassword" 
      class="flex flex-col items-center" @submit.prevent="signUp">
  ...
  methods: {
    ...
    async confirmSignUp() {
      ...
      try {
        ...
        // If all are true then push the user to the Albums
